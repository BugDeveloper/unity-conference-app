...
public class ScrollSnapRect : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler {
    ...
    void Update() {
        ...
        if (_lerp) {
            ...
            float decelerate = Mathf.Min(decelerationRate * UnityEngine.Time.deltaTime, 1f);
    ...
    public void OnEndDrag(PointerEventData aEventData) {
        ...
        if (UnityEngine.Time.unscaledTime - _timeStamp < fastSwipeThresholdTime &&
    ...
    public void OnDrag(PointerEventData aEventData) {
        if (!_dragging) {
            ...
            _timeStamp = UnityEngine.Time.unscaledTime;
